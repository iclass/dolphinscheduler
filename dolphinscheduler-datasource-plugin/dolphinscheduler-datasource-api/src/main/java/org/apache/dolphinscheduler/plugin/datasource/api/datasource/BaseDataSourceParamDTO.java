...
import org.apache.dolphinscheduler.plugin.datasource.api.datasource.mongo.MongoDataSourceParamDTO;
...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(value = MongoDataSourceParamDTO.class, name = "MONGODB"),
