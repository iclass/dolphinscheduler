...
public class MongoDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    private final Logger logger = LoggerFactory.getLogger(MongoDataSourceProcessor.class);
    ...
    public BaseDataSourceParamDTO createDatasourceParamDTO(String connectionJson) {
        MongoConnectionParam connectionParams = (MongoConnectionParam) createConnectionParams(connectionJson);
        MongoDataSourceParamDTO mysqlDatasourceParamDTO = new MongoDataSourceParamDTO();
    ...
    public String getJdbcUrl(ConnectionParam connectionParam) {
        ...
        String jdbcUrl = mongoConnectionParam.getJdbcUrl();
        if (!StringUtils.isEmpty(mongoConnectionParam.getOther())) {
            return String.format("%s?%s&%s", jdbcUrl, mongoConnectionParam.getOther(), APPEND_PARAMS);
        }
    ...
    public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
        MongoConnectionParam mysqlConnectionParam = (MongoConnectionParam) connectionParam;
